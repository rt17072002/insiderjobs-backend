  ...
  return (
    <form onSubmit={onSubmitHandler} className='container p-4 flex flex-col w-full items-start gap-3'>
      ...
      <div>
        ...
        <input className='w-full px-3 py-2 border-2 border-gray-300 rounded sm:w-[120px]' min={0} type="number" placeholder={25000} onChange={e=>setSalary(e.target.value)} value={salary} />
      </div>
