        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {isEdit || userData && userData.resume==="" ? <>
            <label className='flex items-center' htmlFor="resumeUpload">
              ...
              <input type="file" onChange={e => setResume(e.target.files[0])} id="resumeUpload" accept="application/pdf" hidden />
              <img src={assets.profile_upload_icon} alt="" />
            </label>
            <button onClick={updateResume} className='bg-green-100 border border-green-400 rounded-lg px-4 py-2'>Save</button>
          </> : <div className='flex gap-2'>
            <a target="_blank" rel="noreferrer" href={userData?.resume}  className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg'>
              Resume
            </a>
